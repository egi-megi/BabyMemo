...
import 'package:sharing_codelab/pages/calendar_1_page.dart';
import 'package:sharing_codelab/pages/calendar_2_page.dart';
import 'package:sharing_codelab/pages/calendar_3_page.dart';
import 'package:sharing_codelab/pages/calender_page.dart';
...
class LoginPage extends StatelessWidget {
        ...
        return Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: const Text(
                'Zdjęcia dziecka będą trzymane w '
                    'Google Photos',
  ...
  void _navigateToTripList(BuildContext context) {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
        builder: (BuildContext context) => Calendar3Page(),
      ),
    );
  }
}
