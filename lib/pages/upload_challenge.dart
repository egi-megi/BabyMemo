...
class UploadChallengePage extends StatefulWidget {
  const UploadChallengePage({Key key, this.searchResponse, this.challenge})
      : super(key: key);
  ...
  @override
  State<StatefulWidget> createState() => _UploadChallengeState(
      searchResponse: searchResponse, challenge: challenge);
}

class _UploadChallengeState extends State<UploadChallengePage> {
  _UploadChallengeState({this.searchResponse, this.challenge});
          ...
          child: Column(
            children: (challenge.date != null && challenge.mi != null)
                ? <Widget>[
                    ...
                    Text(
                        "${challenge.date.year}-${challenge.date.month}-${challenge.date.day}  "),
                    CachedNetworkImage(
